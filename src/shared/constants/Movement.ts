...
export const CEILING_SEARCH_DISTANCE = 1;
...
export const WALL_RUNNING_SPEED = RUNNING_SPEED;
export const SPEED_TRANSITION_BUFFER = 1;
export const AIR_CONTROL_IMPULSE = 1.5;
export const MAX_AIR_CONTROL_SPEED = WALKING_SPEED;
export const WALL_RUN_DEACCELERATION = 50;
...
export const WALL_JUMP_IMPULSE = JUMP_IMPULSE * 1.5;
...
export const CROUCH_FALL_SETTLE_THRESHOLD = 2;
export const CROUCH_FALL_MIN_SETTLE_TIME = 0.1;
export const CROUCH_FALL_MAX_SETTLE_TIME = 0.5;
